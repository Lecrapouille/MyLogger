...
protected:
  ...
  //! when loading a MyLogger file: this allows to traverse its
  //! resources (a MyLogger file is a zip file containing directories
  //! and files). A stack is usefull when loading a MyLogger file that
  //! loads another MyLogger file.)
